...
export default function AllProjects() {
  ...
  return (
    <ThemeProvider>
      <div className="font-inter bg-gray-200 bg-fixed bg-center bg-no-repeat bg-cover dark:bg-[url('/images/background.svg')] dark:bg-slate-950 dark:bg-fixed dark:bg-center dark:bg-no-repeat dark:bg-cover">
        <NavBar />
        <section id="projects" className=" py-20 md:px-10 px-5 ">
          <div className="flex flex-col items-center gap-5 max-w-screen-xl mx-auto">
            <div className="flex flex-col items-center max-w-screen-xl text-start gap-10">
              <motion.div initial={{opacity: 0}} animate={{opacity: 1}} className="flex flex-col gap-2 text-center justify-center">
