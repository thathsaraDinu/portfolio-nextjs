...
export default function Hero() {
  return (
    <section id="home" className="2xl:h-[700px]  lg:h-screen  ">
      <div className="max-w-screen-xl mx-auto py-20 px-5 gap-5 flex justify-between items-center">
        <ScrollAnimation initial={ { opacity: 0, x:-100}} className="md:w-1/2  flex flex-col gap-4 items-start  max-w-[600px]">
