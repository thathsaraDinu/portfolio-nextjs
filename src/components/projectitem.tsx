...
export function ProjectItem({
  ...
  return (
    <ScrollAnimation className="dark:bg-slate-800 bg-slate-300  border dark:border-slate-600 border-slate-400 relative h-[350px] col-span-1 dark:text-blue-100 text-blue-950 rounded-md shadow-md z-10 ">
      <a className="flex flex-col h-full w-full " href={link} target="_blank">
        <img className="h-[150px] rounded-t-md object-cover" alt="project_image" src={imageUrl} />
